...
\section{Evaluation}
	...
	Each platform has its strong points/ different tools.

	Platforms bring about promise for collaboration.

	Ability to reach to others across the globe is a positive.

	Great for team organization.

	Different settings of formality would call for different approaches or rule sets

	Better team ethic observed.

	requires balance.

	Students didnt tend to involve interpersonal relationships.

	Staff would need to be in the know

	most paper found positive outcomes.
...
\section{Research Methodology}
	...
	interpretivist approach as the application of this platform and the observations of its utility align with the social
